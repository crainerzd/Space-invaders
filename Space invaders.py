...
IMG_NAMES 	= ["ship.png", "mystery.png", "enemy1_1.png", "enemy1_2.png", "enemy2_1.png", "enemy2_2.png","enemy3_1.png", "enemy3_2.png", "explosionblue.png", "explosiongreen.png", "explosionpurple.png", "laser.png", "enemylaser.png"]
IMAGES 		= {name: image.load(format(name)).convert_alpha()
                for name in IMG_NAMES}
class laser(sprite.Sprite):
    def __init__(self, xpos, ypos, direction, speed, filename, side):
        sprite.Sprite.__init__(self)
        self.image = IMAGES[filename]
        self.image.get_rect(topleft=(xpos, ypos))
        self.speed = speed
...
class SpaceInvaders(object):
    def __init__(self):
        ...
        self.screen = SCREEN
        self.background = image.load('background.jpg').convert()
